...
<div style="margin-left: 60px;" class="col-md-11 content">
           <%
                if(session.getAttribute("success") != null && !session.getAttribute("success").toString().isEmpty()) {
            %>
            <p style="color: green;">Requested admin about your proposal successfully</p>
            <%
            ...
            <div class="form-group form-group-md">
               ...
               <div class="col-md-6">
                <input class="form-control" type="text" required
                    placeholder="Name of the fund raiser" value="<%= session.getAttribute("user") %>" readonly name="founder">
                </div>
              </div>
                ...
                <div class="form-group">
                       <div class="col-sm-offset-4 col-md-10">
                         <button type="submit" name="submit" value="add" class="btn btn-default">Add new Charity</button>
                       </div>
                 </div>
           </form>
         </div>
